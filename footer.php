          ...
          <div class="row g-5">
              <div class="col-md-6 col-lg-6 col-xl-3">
                  <div class="footer-item d-flex flex-column">
                      <h4 class="text-white mb-4">VIZHI ENTERPRISES</h4>
                      <p>We specialize in manufacturing a variety of flours, including idiyappam, rice, and ragi, using only locally sourced organic ingredients.
                      </p>
