            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <ul class="navbar-nav mx-4 text-capitalize">
                        <li class="nav-item mt-0 p-0"><a href="" class="nav-link">Home</a></li>
                        <li class="nav-item mt-0 p-0"><a href="add-sub-cat.php" class="nav-link">About</a></li>
                        <li class="nav-item mt-0 p-0"><a href="add-inner-cat.php" class="nav-link">Products</a></li>
                        <li class="nav-item mt-0 p-0"><a href="add-micro-cat.php" class="nav-link"> add Micro category</a></li>
                        <li class="nav-item mt-0 p-0"><a href="add-product.php" class="nav-link">Services</a></li>
                    </ul>
                    <!-- /sidebar menu -->
