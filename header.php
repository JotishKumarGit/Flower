        ...
        <div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                <a href="index.html" class="navbar-brand p-0">
                    <h1 class="text-primary m-0"></i>VIZHI ENTERPRISES</h1>
                    ...
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="appointment.html" class="dropdown-item">Rice Flour</a>
                                <a href="feature.html" class="dropdown-item">Raggi Flour</a>
                                <a href="blog.html" class="dropdown-item">Herberal Hair Oil </a>
                            </div>
                        </div>
